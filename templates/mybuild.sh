...
copy_xcode4_project_templates(){
	TEMPLATE_DIR="mybuild/"

	print_template_banner "Copy Xcode 4 Beeframework iOS template"
	...
	# - reachabilitiy
	# - touchXML
	print_template_banner "Copy Xcode 4 ASI iOS template"
	...
	print_template_banner "Copy Xcode 4 fmdb iOS template"
	...
	print_template_banner "Copy Xcode 4 jsonkit iOS template"
	...
	print_template_banner "Copy Xcode 4 reachabilitiy iOS template"
	...
	print_template_banner "Copy Xcode 4 touchXML iOS template"
	...
	print_template_banner "Copy Xcode 4 Examples Lessons iOS template"
